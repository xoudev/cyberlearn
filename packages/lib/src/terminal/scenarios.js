...
exports.TERMINAL_SCENARIO_IDS = exports.TERMINAL_SCENARIOS = void 0;
exports.getTerminalScenario = getTerminalScenario;
exports.TERMINAL_SCENARIOS = {
  // ── nmap-basic ─────────────────────────────────────────────────────────────
  "nmap-basic": {
...
function getTerminalScenario(id) {
  if (!Object.hasOwn(exports.TERMINAL_SCENARIOS, id)) return undefined;
  return exports.TERMINAL_SCENARIOS[id];
}
/** All registered scenario IDs. */
exports.TERMINAL_SCENARIO_IDS = Object.keys(exports.TERMINAL_SCENARIOS);
