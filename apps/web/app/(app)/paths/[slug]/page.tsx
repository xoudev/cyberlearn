...
// Decorative badge teaser (no per-path badge data exists — kept as a placeholder,
// mirroring the previous page; the "Voir la collection" link is the real action).
const BADGE_GLYPHS: Record<string, React.JSX.Element> = {
  drop: (
    <svg
      width="24"
      height="24"
      ...
      strokeLinejoin="round"
    >
      <path d="M12 4 C12 4 6 11 6 15 a6 6 0 0 0 12 0 C18 11 12 4 12 4 Z" />
    </svg>
  ),
  db: (
    <svg
    ...
    >
      ...
      <path d="M6 6 V12 C6 13.3 8.7 14.4 12 14.4 C15.3 14.4 18 13.3 18 12 V6" />
      <path d="M6 12 V18 C6 19.3 8.7 20.4 12 20.4 C15.3 20.4 18 19.3 18 18 V12" />
    </svg>
  ),
  bug: (
    <svg
    ...
    >
      ...
      <path d="M12 8 V5 M9 6 L7 4 M15 6 L17 4 M8 11 H5 M16 11 H19 M8 15 H5 M16 15 H19" />
    </svg>
  ),
  key: (
    <svg
    ...
    >
      ...
      <path d="M11 11 L19 19 M16 16 L18 14 M14 14 L16 12" />
    </svg>
  ),
  radar: (
    <svg
  ...
  flag: (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M6 3 V21 M6 4 H17 L14.5 8 L17 12 H6" />
    </svg>
  ),
};
        ...
        <aside className="pd2-aside">
          ...
          <div className="ablock">
            ...
            <div className="badge-legend">
              ...
              <span>
                <i className="bz-legendary" />
                Legendary
              </span>
            </div>
            <Link href="/badges" className="aside-cta">
              Voir la collection →
            </Link>
          </div>
        </aside>
