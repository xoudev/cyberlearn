    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        >
          ...
          <div style={{ fontSize: 14, color: "#B8B5D1", lineHeight: "1.7", margin: "4px 0 8px" }}>
            <p style={{ margin: "0 0 14px", color: "#F5F5FA", fontWeight: 500 }}>
              Cette action est{" "}
              <span style={{ color: "#FF4757", fontWeight: 700 }}>irréversible</span>. Les éléments
              suivants seront supprimés ou anonymisés :
            </p>
            <ul
              style={{
                paddingLeft: 0,
