...
export default async function OnboardingAvatarPage(): Promise<React.ReactElement> {
  ...
  return (
    ...
    >
      ...
      >
              ...
              >
                <span
                  style={{
                    ...
                    background: state === "pending" ? "transparent" : "currentColor",
        ...
        <AvatarForm currentAvatarUrl={dbUser.avatarUrl} />
      </div>
    </div>
  );
}
