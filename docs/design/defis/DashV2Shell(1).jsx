// DashV2Shell.jsx — Navbar + Sidebar (Challenges active)
function V2Navbar() {
  return (
...
function V2Sidebar() {
  ...
  const Icon = ({ name }) => {
    ...
    switch (name) {
      ...
      case 'target': return (<svg viewBox="0 0 16 16" {...s}><circle cx="8" cy="8" r="6"/><circle cx="8" cy="8" r="3"/><circle cx="8" cy="8" r="0.6" fill="currentColor"/></svg>);
      default: return null;
    }
  };
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar__nav">
        ...
        <a href="#" className="nav-link is-active is-active--danger"><Icon name="target" /><span>Défis</span><span className="nav-link__count">3</span></a>
      </nav>
