// Sidebar.jsx — Left nav + XP progress
function Sidebar() {
  const items = [
    { label: 'Dashboard', icon: 'dashboard', active: false, count: null },
    { label: 'Leçons', icon: 'book', active: true, count: 142 },
    ...
    <aside className="sidebar">
      ...
      <nav className="sidebar__nav">
        ...
        <a href="#" className="nav-link">
          <Icon name="badge" />
          <span>Défis</span>
          <span className="nav-link__count">3</span>
        </a>
      </nav>
      ...
      <div className="sidebar__footer">
        ...
        <div className="xp-bar">
          <div className="xp-bar__fill" style={{ width: '81%' }} />
        </div>
        <div className="xp-mini__next">
          <b>660 XP</b> avant le prochain palier
        </div>
      </div>
    </aside>
  );
