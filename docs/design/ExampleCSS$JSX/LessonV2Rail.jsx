// LessonV2Rail.jsx — TOC, First Blood, Rating + Next-up bar
function LV2Rail() {
  const toc = [
    { n: '01', label: 'Pourquoi SQLi reste #1', meta: '✓', state: 'is-done' },
    { n: '02', label: "Qu'est-ce qu'une injection SQL", meta: '✓', state: 'is-done' },
    { n: '03', label: 'Un exemple concret', meta: '✓', state: 'is-done' },
    { n: '04', label: "Comment s'en défendre", meta: '~', state: 'is-active' },
    { n: '05', label: 'Quiz de validation', meta: '2m', state: '' },
  ];
  return (
    <aside className="rail-v2">
      ...
      <section>
        <div className="rail-v2__head">First Blood · <b>top 3</b></div>
...
const lv2Root = ReactDOM.createRoot(document.getElementById('root'));
lv2Root.render(<LessonV2App />);
