 ...
 * configured under Auth → Hooks. The behaviour is controlled by
 ...
 *    (Optionally HOOK_VERIFY_ENFORCE=true once validated.)
 *
 * Docs: https://supabase.com/docs/guides/auth/auth-hooks#custom-access-token-hook
 */

import { handleHookRequest } from "./handler.ts";

Deno.serve((req: Request) => handleHookRequest(req));
